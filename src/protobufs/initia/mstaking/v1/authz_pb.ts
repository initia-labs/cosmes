...
// @generated from file initia/mstaking/v1/authz.proto (package initia.mstaking.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from enum initia.mstaking.v1.AuthorizationType
 */
...
proto3.util.setEnumType(AuthorizationType, "initia.mstaking.v1.AuthorizationType", [
 ...
 *
 * @generated from message initia.mstaking.v1.StakeAuthorization
 */
export class StakeAuthorization extends Message<StakeAuthorization> {
   ...
   *
   * @generated from field: repeated cosmos.base.v1beta1.Coin max_tokens = 1;
   */
  maxTokens: Coin[] = [];
   ...
   *
   * @generated from oneof initia.mstaking.v1.StakeAuthorization.validators
   */
  validators: {
    /**
     ...
     * account.
     *
     * @generated from field: initia.mstaking.v1.StakeAuthorization.Validators allow_list = 2;
     */
     ...
     *
     * @generated from field: initia.mstaking.v1.StakeAuthorization.Validators deny_list = 3;
     */
    value: StakeAuthorization_Validators;
    case: "denyList";
   ...
   *
   * @generated from field: initia.mstaking.v1.AuthorizationType authorization_type = 4;
   */
  ...
  static readonly typeName = "initia.mstaking.v1.StakeAuthorization";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "max_tokens", kind: "message", T: Coin, repeated: true },
 ...
 *
 * @generated from message initia.mstaking.v1.StakeAuthorization.Validators
 */
export class StakeAuthorization_Validators extends Message<StakeAuthorization_Validators> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "initia.mstaking.v1.StakeAuthorization.Validators";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
