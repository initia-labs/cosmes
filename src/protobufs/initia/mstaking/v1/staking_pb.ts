...
// @generated from file initia/mstaking/v1/staking.proto (package initia.mstaking.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from enum initia.mstaking.v1.BondStatus
 */
...
proto3.util.setEnumType(BondStatus, "initia.mstaking.v1.BondStatus", [
 ...
 *
 * @generated from enum initia.mstaking.v1.Infraction
 */
...
proto3.util.setEnumType(Infraction, "initia.mstaking.v1.Infraction", [
 ...
 * a validator.
 *
 * @generated from message initia.mstaking.v1.CommissionRates
 */
export class CommissionRates extends Message<CommissionRates> {
  ...
  static readonly typeName = "initia.mstaking.v1.CommissionRates";
 ...
 *
 * @generated from message initia.mstaking.v1.Commission
 */
export class Commission extends Message<Commission> {
  /**
   * commission_rates defines the initial commission rates to be used for creating a validator.
   *
   * @generated from field: initia.mstaking.v1.CommissionRates commission_rates = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "initia.mstaking.v1.Commission";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message initia.mstaking.v1.Description
 */
export class Description extends Message<Description> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "initia.mstaking.v1.Description";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message initia.mstaking.v1.Validator
 */
export class Validator extends Message<Validator> {
   ...
   *
   * @generated from field: initia.mstaking.v1.BondStatus status = 4;
   */
   ...
   *
   * @generated from field: repeated cosmos.base.v1beta1.Coin tokens = 5;
   */
  tokens: Coin[] = [];
   ...
   *
   * @generated from field: repeated cosmos.base.v1beta1.DecCoin delegator_shares = 6;
   */
   ...
   *
   * @generated from field: initia.mstaking.v1.Description description = 7;
   */
   ...
   *
   * @generated from field: initia.mstaking.v1.Commission commission = 10;
   */
   ...
   *
   * @generated from field: repeated cosmos.base.v1beta1.Coin voting_powers = 11;
   */
  votingPowers: Coin[] = [];
   ...
   *
   * @generated from field: string voting_power = 12;
   */
  votingPower = "";
   ...
   *
   * @generated from field: int64 unbonding_on_hold_ref_count = 13;
   */
   ...
   *
   * @generated from field: uint64 unbonding_id = 14;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "initia.mstaking.v1.Validator";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 5, name: "tokens", kind: "message", T: Coin, repeated: true },
    { no: 6, name: "delegator_shares", kind: "message", T: DecCoin, repeated: true },
    ...
    { no: 11, name: "voting_powers", kind: "message", T: Coin, repeated: true },
    { no: 12, name: "voting_power", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 13, name: "unbonding_on_hold_ref_count", kind: "scalar", T: 3 /* ScalarType.INT64 */ },
    { no: 14, name: "unbonding_id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
  ]);
 ...
 *
 * @generated from message initia.mstaking.v1.ValAddresses
 */
export class ValAddresses extends Message<ValAddresses> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "initia.mstaking.v1.ValAddresses";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message initia.mstaking.v1.DVPair
 */
export class DVPair extends Message<DVPair> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "initia.mstaking.v1.DVPair";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message initia.mstaking.v1.DVPairs
 */
export class DVPairs extends Message<DVPairs> {
  /**
   * @generated from field: repeated initia.mstaking.v1.DVPair pairs = 1;
   */
  pairs: DVPair[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "initia.mstaking.v1.DVPairs";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message initia.mstaking.v1.DVVTriplet
 */
export class DVVTriplet extends Message<DVVTriplet> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "initia.mstaking.v1.DVVTriplet";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "delegator_address", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message initia.mstaking.v1.DVVTriplets
 */
export class DVVTriplets extends Message<DVVTriplets> {
  /**
   * @generated from field: repeated initia.mstaking.v1.DVVTriplet triplets = 1;
   */
  triplets: DVVTriplet[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "initia.mstaking.v1.DVVTriplets";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * validator.
 *
 * @generated from message initia.mstaking.v1.Delegation
 */
export class Delegation extends Message<Delegation> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "initia.mstaking.v1.Delegation";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "delegator_address", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "validator_address", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message initia.mstaking.v1.UnbondingDelegation
 */
export class UnbondingDelegation extends Message<UnbondingDelegation> {
   ...
   *
   * @generated from field: repeated initia.mstaking.v1.UnbondingDelegationEntry entries = 3;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "initia.mstaking.v1.UnbondingDelegation";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "delegator_address", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "validator_address", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message initia.mstaking.v1.UnbondingDelegationEntry
 */
export class UnbondingDelegationEntry extends Message<UnbondingDelegationEntry> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "initia.mstaking.v1.UnbondingDelegationEntry";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message initia.mstaking.v1.RedelegationEntry
 */
export class RedelegationEntry extends Message<RedelegationEntry> {
   ...
   *
   * @generated from field: repeated cosmos.base.v1beta1.DecCoin shares_dst = 4;
   */
  sharesDst: DecCoin[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "initia.mstaking.v1.RedelegationEntry";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "creation_height", kind: "scalar", T: 3 /* ScalarType.INT64 */ },
    { no: 2, name: "completion_time", kind: "message", T: Timestamp },
    { no: 3, name: "initial_balance", kind: "message", T: Coin, repeated: true },
    { no: 4, name: "shares_dst", kind: "message", T: DecCoin, repeated: true },
    { no: 5, name: "unbonding_id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 6, name: "unbonding_on_hold_ref_count", kind: "scalar", T: 3 /* ScalarType.INT64 */ },
  ]);
 ...
 *
 * @generated from message initia.mstaking.v1.Redelegation
 */
export class Redelegation extends Message<Redelegation> {
   ...
   *
   * @generated from field: repeated initia.mstaking.v1.RedelegationEntry entries = 4;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "initia.mstaking.v1.Redelegation";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "delegator_address", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "validator_src_address", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "validator_dst_address", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message initia.mstaking.v1.Params
 */
export class Params extends Message<Params> {
   ...
   *
   * @generated from field: repeated string bond_denoms = 5;
   */
  bondDenoms: string[] = [];
   ...
   *
   * @generated from field: uint64 min_voting_power = 6;
   */
  minVotingPower = protoInt64.zero;

  /**
   * min_commission_rate is the chain-wide minimum commission rate that a validator can charge their delegators
   *
   * @generated from field: string min_commission_rate = 7;
   */
  minCommissionRate = "";
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "initia.mstaking.v1.Params";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 5, name: "bond_denoms", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
    { no: 6, name: "min_voting_power", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 7, name: "min_commission_rate", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
 ...
 *
 * @generated from message initia.mstaking.v1.DelegationResponse
 */
export class DelegationResponse extends Message<DelegationResponse> {
  /**
   * @generated from field: initia.mstaking.v1.Delegation delegation = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "initia.mstaking.v1.DelegationResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * responses.
 *
 * @generated from message initia.mstaking.v1.RedelegationEntryResponse
 */
export class RedelegationEntryResponse extends Message<RedelegationEntryResponse> {
  /**
   * @generated from field: initia.mstaking.v1.RedelegationEntry redelegation_entry = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "initia.mstaking.v1.RedelegationEntryResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * responses.
 *
 * @generated from message initia.mstaking.v1.RedelegationResponse
 */
export class RedelegationResponse extends Message<RedelegationResponse> {
  /**
   * @generated from field: initia.mstaking.v1.Redelegation redelegation = 1;
   */
  redelegation?: Redelegation;

  /**
   * @generated from field: repeated initia.mstaking.v1.RedelegationEntryResponse entries = 2;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "initia.mstaking.v1.RedelegationResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * denomination.
 *
 * @generated from message initia.mstaking.v1.Pool
 */
export class Pool extends Message<Pool> {
  /**
   * @generated from field: repeated cosmos.base.v1beta1.Coin not_bonded_tokens = 1;
   */
  notBondedTokens: Coin[] = [];

  /**
   * @generated from field: repeated cosmos.base.v1beta1.Coin bonded_tokens = 2;
   */
  bondedTokens: Coin[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "initia.mstaking.v1.Pool";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "not_bonded_tokens", kind: "message", T: Coin, repeated: true },
    { no: 2, name: "bonded_tokens", kind: "message", T: Coin, repeated: true },
  ]);
